...
<Image :src="'/browser/event-loop/1.png'" />
...
<Image :src="'/browser/event-loop/2.png'" />
...
<Image :src="'/browser/event-loop/3.png'" />

<Image :src="'/browser/event-loop/4.png'" />
...
<Image :src="'/browser/event-loop/7.png'" />
