import{_ as s,c as n,o as a,h as l}from"./app.f9f5284b.js";const m=JSON.parse('{"title":"\u6A21\u5F0F\u4E03\u2014\u2014\u88C5\u9970\u5668\u6A21\u5F0F","description":"","frontmatter":{},"headers":[],"relativePath":"blogs/js-ts/js/design-mode/zhuangshiqimoshi.md","lastUpdated":1676908139000}'),p={name:"blogs/js-ts/js/design-mode/zhuangshiqimoshi.md"},e=l(`<h1 id="\u6A21\u5F0F\u4E03\u2014\u2014\u88C5\u9970\u5668\u6A21\u5F0F" tabindex="-1">\u6A21\u5F0F\u4E03\u2014\u2014\u88C5\u9970\u5668\u6A21\u5F0F <a class="header-anchor" href="#\u6A21\u5F0F\u4E03\u2014\u2014\u88C5\u9970\u5668\u6A21\u5F0F" aria-hidden="true">#</a></h1><p>\u88C5\u9970\u5668\u6A21\u5F0F\u80FD\u591F\u5F88\u597D\u7684\u5BF9\u5DF2\u6709\u7684\u529F\u80FD\u8FDB\u884C\u62D3\u5C55\uFF0C\u8FD9\u6837\u4E0D\u4F1A\u66F4\u6539\u539F\u6709\u7684\u4EE3\u7801\uFF0C\u5BF9\u5176\u4ED6\u7684\u4E1A\u52A1\u4EA7\u751F\u5F71\u54CD\uFF0C\u8FD9\u65B9\u4FBF\u6211\u4EEC\u5728\u8F83\u5C11\u7684\u6539\u52A8\u4E0B\u5BF9\u8F6F\u4EF6\u7684\u529F\u80FD\u8FDB\u884C\u62D3\u5C55\u3002</p><div class="language- line-numbers-mode"><button class="copy"></button><span class="lang"></span><pre><code><span class="line"><span style="color:#A6ACCD;">Function.property.before = function(beforeFn) {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">		beforeFn.apply(this, argument);</span></span>
<span class="line"><span style="color:#A6ACCD;">		return _this.apply(this, argument);</span></span>
<span class="line"><span style="color:#A6ACCD;">	}</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;">Function.property.after = function(afterFn) {</span></span>
<span class="line"><span style="color:#A6ACCD;">	var _this = this;</span></span>
<span class="line"><span style="color:#A6ACCD;">	return function() {</span></span>
<span class="line"><span style="color:#A6ACCD;">		var ret = _this.apply(this, argument);</span></span>
<span class="line"><span style="color:#A6ACCD;">		afterFn.apply(this, argument);</span></span>
...
<span class="line"><span style="color:#A6ACCD;">	render();</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div>`,7),r=[e];function c(o,t,i,b,u,A){return a(),n("div",null,r)}const y=s(p,[["render",c]]);export{m as __pageData,y as default};
